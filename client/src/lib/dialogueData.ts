...
export const DIALOGUE_DATA: ChapterData = {
  ...
  fertilityDialogue: [
    ...
    },
    {
      type: 'text',
      speaker: 'narrator',
      text: "不是转向一个更好的平台，而是转向彼此，转向那些真正理解困境的人。",
      character: null
    }
  ],
  ...
  ageDialogue: [
    ...
    },
    {
      type: 'text',
      speaker: "李明",
      text: "唉，确实。年纪越大，就越容易被默认身体状况差、未来负担重。那你现在还会写年龄要求吗？",
      character: "liming"
    },
    {
      type: 'text',
      speaker: "小雨",
      text: "不会了。我后来发现，比起'合适的年龄'，有人愿意认真看完我的资料，已经很难得了。",
      character: "xiaoyu"
    },
    {
      type: 'choice',
  ...
  educationDialogue: [
    ...
    },
    {
      type: 'text',
      speaker: "小雨",
      text: "学历、工作、残疾程度……一切都成了'筛选条件'。你看，那些本科以上学历的女性，她们的资料被浏览的次数是高中学历女性的5倍。",
      character: "xiaoyu"
    },
    {
      type: 'text',
    ...
    },
    {
      type: 'text',
      speaker: "小雨",
      text: "我？我早就放弃了'要求'。我现在的要求就是'能接纳我'。",
      character: "xiaoyu"
    },
    {
      type: 'choice',
  ...
  chapter5: [
    ...
    },
    {
      type: 'text',
      speaker: 'narrator',
      text: "李明和小雨的对话还在继续。他们没有找到答案，但他们找到了彼此。",
      character: null
    },
    {
      type: 'text',
